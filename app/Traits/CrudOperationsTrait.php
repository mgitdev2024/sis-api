...
trait CrudOperationsTrait
{
    ...
    public function createRecord($model, $request, $rules, $modelName, $path = null)
    {
        ...
        try {
            ...
            $record->save();
            $this->createProductionLog($model, $record->id, $fields->getAttributes(), $fields['created_by_id'], 0);
    ...
    public function updateRecordById($model, $request, $rules, $modelName, $id)
    {
        ...
        try {
            ...
            if ($record) {
                ...
                $this->createProductionLog($model, $record->id, $fields->getAttributes(), $fields['updated_by_id'], 1);
    ...
    public function changeStatusRecordById($model, $id, $modelName, $request)
    {
        ...
        try {
            ...
            if ($data) {
                ...
                $this->createProductionLog($model, $model->id, $data->getAttributes(), $fields['created_by_id'], 1);
