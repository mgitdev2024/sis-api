...
Route::group(['middleware' => ['auth:sanctum', 'check.system.status:SIS']], function () {
    ...
    Route::get('v1/store/receive-inventory-item/filter/order-type/get/{store_code}/{order_type}/{is_received}/{status?}/{reference_number?}', [App\Http\Controllers\v1\Store\StoreReceivingInventoryItemController::class, 'onGetCountOrderType']);
    #endregion
