...
Route::prefix('v1/public')->middleware('check.api.key')->group(function () {
    ...
    Route::post('/reports/unmet-demand/count/daily', [App\Http\Controllers\v1\Report\StockCountReportController::class, 'onGenerateDailyReport']);
    #endregion
...
Route::group(['middleware' => ['auth:sanctum', 'check.system.status:SIS']], function () {
    ...
    Route::get('v1/unmet-demand/get/{store_code}/{sub_unit?}', [App\Http\Controllers\v1\UnmetDemand\UnmetDemandController::class, 'onGet']);
...
Route::group(['middleware' => ['auth:sanctum', 'check.pending.stock.count', 'check.system.status:SIS']], function () {
    ...
    #region Stock Inventory
    Route::get('v1/stock/inventory/get/{store_code}/{sub_unit?}/{is_viewable_ir?}', [App\Http\Controllers\v1\Stock\StockInventoryController::class, 'onGet']);
