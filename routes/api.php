...
Route::group(['middleware' => ['auth:sanctum', 'check.system.status:SIS']], function () {
    ...
    Route::post('v1/store/receive-inventory-item/manual/get/{reference_number}/{selected_item_codes}', [App\Http\Controllers\v1\Store\StoreReceivingInventoryItemController::class, 'onGetCheckedManual']);
