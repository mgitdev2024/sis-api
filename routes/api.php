...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('v1/storage/sub_location/generate-code/get/{id}', [App\Http\Controllers\v1\WMS\Settings\StorageMasterData\SubLocationController::class, 'onGenerateCode']);
    #endregion
    ...
    Route::get('v1/queue/storage/permanent/current/get/{sub_location_id}/{layer}', [App\Http\Controllers\v1\WMS\Storage\QueuedSubLocationController::class, 'onGetCurrent']);
