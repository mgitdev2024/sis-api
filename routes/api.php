...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('v1/warehouse/receive/complete-transaction/{id}', [App\Http\Controllers\v1\WMS\Warehouse\WarehouseReceivingController::class, 'onCompleteTransactionMVP']);
