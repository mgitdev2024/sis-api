...
Route::group(['middleware' => ['auth:sanctum', 'check.system.status:SCM-WMS']], function () {
    ...
    Route::get('v1/item/disposition/endorsed-by-qa/get/{item_disposition_id}', [App\Http\Controllers\v1\QualityAssurance\ItemDispositionController::class, 'onGetById']);
    #endregion
